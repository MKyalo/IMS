...
<div class="modal fade" id="productInfo{{$prod->id}}">
            ...
            <div class="modal-body">
              ...
              <div class="card bg-light">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                      <h2 class="lead"><b>{{$prod->serial_no}}</b></h2>
                      <p class="text-muted text-sm"><b>About: </b> Web Designer / UX / Graphic Artist / Coffee Lover </p>
                      <ul class="ml-4 mb-0 fa-ul text-muted">
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> purchase_price: {{$prod->purchase_price}} {{$prod->retail_price}}</li>
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Phone #: +{{$prod->product_name}}</li>
